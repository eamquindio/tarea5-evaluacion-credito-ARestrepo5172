...
public class EvaluacionCredito {
     ...
     */
    public EvaluacionCredito(String nombreSolicitante, double ingresosMensuales, int numeroCreditosActivos, int puntajeCredito, double valorCreditoSolicitado, boolean tieneCodedor) {
    ...
    public double calcularCuotaMensual(double tasaNominalAnual, int plazoMeses) {
        ...
        if (tasaNominalAnual > 0) {
            tasaMensual = (tasaNominalAnual / 100.0) / 12.0;
    ...
    public boolean evaluarAprobacion(double tasaNominalAnual, int plazoMeses) {
        ...
        if (puntajeCredito < 500) {
            ...
            if (puntajeCredito < 700) {
                if (tieneCodedor) {
                    cuotaMensual = calcularCuotaMensual(tasaNominalAnual, plazoMeses);
